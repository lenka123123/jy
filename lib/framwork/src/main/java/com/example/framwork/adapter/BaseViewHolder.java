...
public class BaseViewHolder extends RecyclerView.ViewHolder {
    ...
    public BaseViewHolder setLoadalImageUrl(int viewId, int url, int errorSrc) {
        ImageView view = getView(viewId);
    ...
    public BaseViewHolder setRoundImageUrl2(int viewId, String url, int radius) {
        ImageView view = getView(viewId);
        ImageLoaderUtils.displaySquareRound(mContext, view, url, radius);
        return this;
    }
    ...
    public BaseViewHolder setEnabled(int viewId, boolean flag) {
        TextView view = getView(viewId);
