...
package com.example.framwork.swipeback;
...
public class ViewDragHelper {
     ...
     * callback's
     * {@link com.example.framwork.swipeback.ViewDragHelper.Callback#onEdgeTouched(int, int)}
     * and
     * {@link com.example.framwork.swipeback.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
     ...
     * {@link com.example.framwork.swipeback.ViewDragHelper.Callback#tryCaptureView(View, int)}
