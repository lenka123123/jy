...
public class SearchReasultSecretFragment extends BaseFragment implements SearchReasultView, SuperRecyclerView.LoadingListener, SwipeRefreshLayout.OnRefreshListener {

    private String typy = "4";
    ...
    protected void initData() {
        ...
        mSearchReasultPresenter.getSecretData();

        mSearchReasultSSTAdapter = new SearchReasultSSTAdapter(context, mList,6,2);
