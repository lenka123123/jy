...
import sinia.com.baihangeducation.find.adapter.SearchReasultFunnyAdapter;
...
public class SearchReasultFunnyFragment extends BaseFragment implements SearchReasultView, SuperRecyclerView.LoadingListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    private SearchReasultFunnyAdapter mSearchReasultFunnyAdapter;
    private List<SearchResultFunnyInfo> mList;
    ...
    protected void initData() {
        ...
        mSearchReasultPresenter.getFunnyData();

        mSearchReasultFunnyAdapter = new SearchReasultFunnyAdapter(context, mList);
        ...
        initRecyclerView(rvContainer, mSearchReasultFunnyAdapter, this);
    ...
    public void getSearchFunnyData(List<SearchResultFunnyInfo> list, int maxpage) {
        if (list.size() == 0) {
            ...
            mList.addAll(list);
            mSearchReasultFunnyAdapter.notifyDataSetChanged();
        }
    }
