...
public class JobBangClassStrategyActivity extends BaseActivity implements JobBangClassInfoView, SuperRecyclerView.LoadingListener, SwipeRefreshLayout.OnRefreshListener, RadioGroup.OnCheckedChangeListener {
    ...
    protected void initData() {
        ...
        mCommonTitle.setCenterText(R.string.strategy);
        ...
        mJobBangClassSecondAdapter = new JobBangClassSecondAdapter(context, mList, "攻略干货");
