...
public class SearchReasultTestFragment extends BaseFragment implements SearchReasultView, SuperRecyclerView.LoadingListener, SwipeRefreshLayout.OnRefreshListener {

    private String typy = "3";
    ...
    protected void initData() {
        ...
        mSearchReasultPresenter.getTestData();

        mSearchReasultSSTAdapter = new SearchReasultSSTAdapter(context, mList,5,4);
