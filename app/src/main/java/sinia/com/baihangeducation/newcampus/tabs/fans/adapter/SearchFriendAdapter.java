...
import sinia.com.baihangeducation.newcampus.tabs.fans.interfaces.FollowDataListener;
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        vh.addfollow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                commonModel.addFollow(String.valueOf(mInviteListInfo.get(position).user_id), new sinia.com.baihangeducation.newcampus.tabs.searchfriend.interfaces.FollowDataListener() {
                    @Override
