...
import sinia.com.baihangeducation.newcampus.tabs.fans.adapter.FollowAdapter;
...
import sinia.com.baihangeducation.newcampus.tabs.fans.present.FollowListPresent;
import sinia.com.baihangeducation.newcampus.tabs.fans.present.fansListPresent;
import sinia.com.baihangeducation.supplement.base.BaseActivity;
import sinia.com.baihangeducation.supplement.base.Goto;

public class FollowListActivity extends BaseActivity implements FansContract.View {

    private RecyclerView mAutoLoadRecyclerView;
    private FollowListPresent mHotFunListPresent;

    private FollowAdapter hotFunAdapter;
    ...
    protected void initView() {
        ...
        hotFunAdapter = new FollowAdapter(context);
    ...
    protected void initData() {
        ...
        mHotFunListPresent = new FollowListPresent(new fansListModel(context), this);
        currentPage = 1;
        mHotFunListPresent.getHotFunList(user_id, type, currentPage + "", "20"); //  ( 1：获取该用户的粉丝 2：获取该用户的关注 )
        setPullRefresher();
        hotFunAdapter.setItemClickListener(new FollowAdapter.OnItemClickListener() {
            @Override
