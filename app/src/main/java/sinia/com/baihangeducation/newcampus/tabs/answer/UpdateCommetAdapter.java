package sinia.com.baihangeducation.newcampus.tabs.answer;
...
public class UpdateCommetAdapter extends BaseAdapter {
    private List<CommentItem> datasource = new ArrayList<CommentItem>();
    private Context mContext;
    private CommentAdapter.ICommentItemClickListener commentItemClickListener;// 评论点击事件

    public void setCommentClickListener(CommentAdapter.ICommentItemClickListener commentItemClickListener) {
        this.commentItemClickListener = commentItemClickListener;
    }

    public UpdateCommetAdapter(Context context) {
        mContext = context;
    }
     ...
     * @param context
     */
    public UpdateCommetAdapter(Activity context, List<CommentItem> datasource) {
    ...
    @Override
    public int getCount() {
        System.out.println("kkkkkkkkkkkk" + datasource.size());
