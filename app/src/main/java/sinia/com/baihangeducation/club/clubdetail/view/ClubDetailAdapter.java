 ...
 */
public class ClubDetailAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {


    private String text = "";
    private List<ClubDetailBean> mInviteListInfo = new ArrayList<>();
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        viewHolder = new ClubDetailHolder(view);
...
//           RankingRecentHolder holder = new RankingRecentHolder(view);
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ClubDetailHolder vh = (ClubDetailHolder) holder;
