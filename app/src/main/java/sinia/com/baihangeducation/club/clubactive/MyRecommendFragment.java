...
import sinia.com.baihangeducation.club.clubactive.presenter.MyReCommendActivePresenter;
...
import sinia.com.baihangeducation.reconsitution.tabs.coffers.coffersdetail.presenter.RankingWeekPresenter;
 ...
 */
public class MyRecommendFragment extends Fragment implements RankingContract.View {


    private ReCommendAdapter mMemberManageAdapter;
    private List<ActiveListData.ActiveList> mRows = new ArrayList<>();
    private MyReCommendActivePresenter mRankingPresenter;
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if (isVisibleToUser) {
            ...
            mRankingPresenter.getDateRecentMemberManageList(1, 1);
        }
    }
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        isCreated = true;
        mRankingPresenter = new MyReCommendActivePresenter(new ActiveModel(getActivity()), this);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup viewGroup, @Nullable Bundle savedInstanceState) {
        ...
        mMemberManageAdapter = new ReCommendAdapter(getContext(), 3);
    ...
    private void setPullRefresher() {
        ...
        mSmartRefreshLayout.setOnLoadMoreListener(new OnLoadMoreListener() {
            ...
            public void onLoadMore(RefreshLayout refreshlayout) {
                MyRecommendFragment.this.refreshlayout = refreshlayout;
                if (addData) {
                    mRankingPresenter.getDateRecentMemberManageList(1, currentPage);
                } else {
