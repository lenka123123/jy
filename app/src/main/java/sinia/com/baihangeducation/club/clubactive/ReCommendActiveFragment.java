...
import sinia.com.baihangeducation.club.clubactive.presenter.ReCommendActivePresenter;
 ...
 */
public class ReCommendActiveFragment extends Fragment implements RankingContract.View {
    private ReCommendAdapter mMemberManageAdapter;
    private List<ActiveListData.ActiveList> mRows = new ArrayList<>();
    private ReCommendActivePresenter mRankingPresenter;
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if (isVisibleToUser) {
            ...
            //  ( 1：社团活动 2：学校活动 3：公开活动 )
            mRankingPresenter.getDateRecentMemberManageList(3, 1);
        }
    }
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        isCreated = true;
        mRankingPresenter = new ReCommendActivePresenter(new ActiveModel(getActivity()), this);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup viewGroup, @Nullable Bundle savedInstanceState) {
        ...
        mMemberManageAdapter = new ReCommendAdapter(getContext(), 1);
        ...
        if (getUserVisibleHint()) {
            mRankingPresenter.getDateRecentMemberManageList(3, currentPage);
        }
        return root;
    }
