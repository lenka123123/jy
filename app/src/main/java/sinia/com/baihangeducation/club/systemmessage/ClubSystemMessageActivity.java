...
//
//public class ClubSystemMessageActivity extends BaseActivity implements GetRequestListener {
//
...
//        SImagePicker.from(ClubSystemMessageActivity.this)
...
//                try {
//                    MediaStore.Images.Media.insertImage(ClubSystemMessageActivity.this.getContentResolver(), appDir.getAbsolutePath().toString(), appDir.getName(), "");
...
//                .hideSoftInputFromWindow((ClubSystemMessageActivity.this).getCurrentFocus().getWindowToken(), InputMethodManager.HIDE_NOT_ALWAYS);
//
//    }
//
//    @Override
