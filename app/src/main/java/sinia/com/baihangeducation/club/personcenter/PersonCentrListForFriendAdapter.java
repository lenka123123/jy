...
public class PersonCentrListForFriendAdapter extends SuperBaseAdapter<ClubHomeInfo.School> {
    private PersonCenterForFirendActivity activity;
    private Context context;

    public PersonCentrListForFriendAdapter(PersonCenterForFirendActivity activity, List<ClubHomeInfo.School> data) {
        super(activity, data);
