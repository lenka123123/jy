...
import sinia.com.baihangeducation.club.clubactive.presenter.MySchoolPresenter;
...
import sinia.com.baihangeducation.reconsitution.tabs.coffers.coffersdetail.presenter.RankingMonthPresenter;
 ...
 */
public class MySchoolFragment extends Fragment implements RankingContract.View {

    private ReCommendAdapter mMemberManageAdapter;
    private List<ActiveListData.ActiveList> mRows = new ArrayList<>();
    private MySchoolPresenter mRankingPresenter;
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if (isVisibleToUser) {
            ...
            mRankingPresenter.getDateRecentMemberManageList(2, 1);
        }
    }
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        isCreated = true;
        mRankingPresenter = new MySchoolPresenter(new ActiveModel(getActivity()), this);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup viewGroup, @Nullable Bundle savedInstanceState) {
        ...
        mMemberManageAdapter = new ReCommendAdapter(getContext(), 2);
    ...
    private void setPullRefresher() {
        ...
        mSmartRefreshLayout.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh(RefreshLayout refreshlayout) {
                if (addData) {
                    currentPage = 1;
                    mRankingPresenter.getDateRecentMemberManageList(2, currentPage);
                } else {
        ...
        mSmartRefreshLayout.setOnLoadMoreListener(new OnLoadMoreListener() {
            ...
            public void onLoadMore(RefreshLayout refreshlayout) {
                MySchoolFragment.this.refreshlayout = refreshlayout;
                if (addData) {
                    mRankingPresenter.getDateRecentMemberManageList(2, currentPage);
                } else {
