...
import sinia.com.baihangeducation.club.clubactive.MyRecommendFragment;
 ...
 */
public class MyReCommendActivePresenter implements RankingContract.Presenter {

    private ActiveModel rankingModel;
    private MyRecommendFragment dayRankingFragment;


    public MyReCommendActivePresenter(ActiveModel rankingModel, MyRecommendFragment dayRankingFragment) {
