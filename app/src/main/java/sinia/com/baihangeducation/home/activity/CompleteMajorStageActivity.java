...
import sinia.com.baihangeducation.home.adapter.CompleteMajorNumberOneAdapter;
 ...
 */
public class CompleteMajorStageActivity extends BaseActivity implements IGetEducationView, SuperRecyclerView.LoadingListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    private CompleteMajorNumberOneAdapter choiceMajorAdapter;
    ...
    protected void initData() {
        ...
        presenter.getMajor();
        choiceMajorAdapter = new CompleteMajorNumberOneAdapter(context, marjorList);
        ...
        initRecyclerView(rvContainer, choiceMajorAdapter, this);
    }
    ...
    public void getEducationMajor_1_Success(List<Marjor> list, int maxpage) {
        if (list.size() == 0) {
            ...
            choiceMajorAdapter.notifyDataSetChanged();
        }
    }
