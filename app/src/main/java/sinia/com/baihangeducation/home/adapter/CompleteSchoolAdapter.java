...
public class CompleteSchoolAdapter extends SuperBaseAdapter<College> {
    private Context context;
    private ACache cache;

    public CompleteSchoolAdapter(Context context, List<College> data) {
        super(context, data);
    ...
    protected void convert(BaseViewHolder holder, final College item, int position) {
        ...
        holder.setOnClickListener(R.id.tv_choiceschoolormajoritem, new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                cache.put("HOMESCHOOLNAME",item.college_name);
                cache.put("HOMESCHOOLID",item.college_id+"");
