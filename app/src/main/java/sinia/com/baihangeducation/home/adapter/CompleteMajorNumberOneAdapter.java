...
public class CompleteMajorNumberOneAdapter extends SuperBaseAdapter<Marjor> {
    private Context context;
    private MyApplication application;
    private MyResumInfo myResumInfo;

    public CompleteMajorNumberOneAdapter(Context context, List<Marjor> data) {
        super(context, data);
    ...
    protected void convert(BaseViewHolder holder, final Marjor item, int position) {
        ...
        holder.setOnClickListener(R.id.tv_choiceschoolormajoritem, new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Goto.toCompleteMajor_2Activity(context,item.major_id+"");
