...
public class PartTimeJobCLubDetailActivity extends BaseActivity implements JobInfoView, AddCollctionView, GeocodeSearch.OnGeocodeSearchListener {
...
//        web.setThumb(thumb);  //缩略图
        new ShareAction(PartTimeJobCLubDetailActivity.this)
                .setPlatform(media)
                .withMedia(web)
