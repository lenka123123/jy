 ...
 */
public class BringCoffersFragment extends Fragment implements RankingContract.View {

    private RankingRecentAdapter mMemberManageAdapter;
    private List<CoffersDetail.Coffers> mRows = new ArrayList<>();
    private RankingMonthPresenter mRankingPresenter;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        isCreated = true;
        mRankingPresenter = new RankingMonthPresenter(new RankingModel(getActivity()), this);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup viewGroup, @Nullable Bundle savedInstanceState) {
        ...
        mMemberManageAdapter = new RankingRecentAdapter(getContext(), 2);
    ...
    private void setPullRefresher() {
        ...
        mSmartRefreshLayout.setOnLoadMoreListener(new OnLoadMoreListener() {
            ...
            public void onLoadMore(RefreshLayout refreshlayout) {
                BringCoffersFragment.this.refreshlayout = refreshlayout;
                if (addData) {
                    mRankingPresenter.getDateRecentMemberManageList(2, currentPage);
                } else {
