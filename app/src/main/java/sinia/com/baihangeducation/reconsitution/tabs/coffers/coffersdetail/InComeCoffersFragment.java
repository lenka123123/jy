 ...
 */
public class InComeCoffersFragment extends Fragment implements RankingContract.View {


    private RankingRecentAdapter mMemberManageAdapter;
    private List<CoffersDetail.Coffers> mRows = new ArrayList<>();
    private RankingWeekPresenter mRankingPresenter;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        isCreated = true;
        mRankingPresenter = new RankingWeekPresenter(new RankingModel(getActivity()), this);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup viewGroup, @Nullable Bundle savedInstanceState) {
        ...
        mMemberManageAdapter = new RankingRecentAdapter(getContext(), 3);
    ...
    private void setPullRefresher() {
        ...
        mSmartRefreshLayout.setOnLoadMoreListener(new OnLoadMoreListener() {
            ...
            public void onLoadMore(RefreshLayout refreshlayout) {
                InComeCoffersFragment.this.refreshlayout = refreshlayout;
                if (addData) {
                    mRankingPresenter.getDateRecentMemberManageList(1, currentPage);
                } else {
