...
import com.mcxtzhang.swipemenulib.utils.ScaleTypeFillCenterInside;
...
public class FrescoImageLoader implements ImageLoader {
  ...
  private void init() {
    DiskCacheConfig diskCacheConfig =
        DiskCacheConfig
            .newBuilder(MyApplication.sContext)
