...
//        }
        if (requestCode == Constants.REQUEST_CODE_MAIN && resultCode == Constants.RESULT_CODE_VIEW_IMG) {
            ...
            System.out.println(toDeletePicList.size() + "toDeletePicList ee================");
            if (toDeletePicList.size() >= 1) System.out.println(toDeletePicList.get(0));
            mAdapter.setData(toDeletePicList);
        }
    }
