package sinia.com.baihangeducation.chat.chatsetting;
...
import sinia.com.baihangeducation.chat.view.ChatDetailController;
import sinia.com.baihangeducation.chat.view.ChatDetailView;
...
public class ChatDetailActivity extends ImBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        messageSwitch = (Switch) findViewById(R.id.no_disturb_slip_btn);
        mTopSwitch = (Switch) findViewById(R.id.no_disturb_slip_top);

        mChatDetailController.initNoDisturbView(messageSwitch);
        mChatDetailController.initTopView(mTopSwitch);

        messageSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                System.out.println("设置消息置顶tp" + isChecked);
                mChatDetailController.onChanged(R.id.no_disturb_slip_btn, isChecked);
            }
        });
//        mTopSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
//            @Override
//            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
//                System.out.println("设置消息置顶tp1qq" + isChecked);
//                mChatDetailController.onChanged(R.id.no_disturb_slip_top,isChecked);
//            }
//        });
    }
        ...
        if (data != null) {
            ...
            switch (requestCode) {
                ...
                case MY_NAME_REQUEST_CODE:
                    ...
                    break;
                case MyApplication.REQUEST_CODE_ALL_MEMBER:
...
//        startActivity(intent);
    ...
    public void startChatActivity(long groupID, String groupName, int member) {
        ...
        intent.putExtra(MyApplication.MEMBERS_COUNT, member + 1);
        intent.putExtra(MyApplication.GROUP_ID, groupID);
        intent.putExtra(MyApplication.CONV_TITLE, groupName);
