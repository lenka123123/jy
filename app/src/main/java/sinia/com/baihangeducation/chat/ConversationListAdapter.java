...
import sinia.com.baihangeducation.chat.view.SwipeLayoutConv;
import sinia.com.baihangeducation.chat.view.ViewHolder;
...
import sinia.com.baihangeducation.supplement.tool.ThreadUtil;
                        ...
                        if (MyApplication.isAtall.get(gid) != null && MyApplication.isAtall.get(gid)) {
                            ...
                            if (lastMsg.getUnreceiptCnt() == 0) {
                                ...
                                if (lastMsg.getTargetType().equals(ConversationType.single) &&
                                    ...
                                    SpannableStringBuilder builder = new SpannableStringBuilder(contentStr);
//                                    builder.setSpan(new ForegroundColorSpan(mContext.getResources().getColor(R.color.white)),
            ...
            if (mUserInfo != null) {
                mUserInfo.getAvatarBitmap(new GetAvatarBitmapCallback() {
                    ...
                    public void gotResult(int status, String desc, Bitmap bitmap) {
                        if (status == 0) {
                            RoundedBitmapDrawable circularBitmapDrawable = RoundedBitmapDrawableFactory.create(content.getResources(), bitmap);
...
//                            headIcon.setImageBitmap(bitmap);
                            ...
                            RoundedBitmapDrawable circularBitmapDrawable = RoundedBitmapDrawableFactory.create(content.getResources(),
                                    BitmapFactory.decodeResource(content.getResources(), R.drawable.group));
                            circularBitmapDrawable.setCircular(true);
                            headIcon.setImageDrawable(circularBitmapDrawable);
