...
import sinia.com.baihangeducation.mine.adapter.MyCollectionFunAndInfoAdapter;
...
public class MyCollectionInformationFragment extends BaseFragment implements MyCollectionView, SuperRecyclerView.LoadingListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    private MyCollectionFunAndInfoAdapter myCollectionFunAndInfoAdapter;
    ...
    protected void initData() {
        ...
        myCollectionFunAndInfoAdapter = new MyCollectionFunAndInfoAdapter(context, mList);
        ...
        initRecyclerView(rvContainer, myCollectionFunAndInfoAdapter, this);
    ...
    public String getType() {
        return Constants.MYCOLLECTION_INFORMATION;
    }
    ...
    public void getInformationSuccess(List<MyCollectionListInfo> list, int maxpage) {
        if (list.size() == 0) {
            ...
            mList.addAll(list);
            myCollectionFunAndInfoAdapter.notifyDataSetChanged();
        }
    }
