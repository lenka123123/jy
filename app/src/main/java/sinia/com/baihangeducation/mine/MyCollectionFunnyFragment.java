...
import sinia.com.baihangeducation.mine.adapter.MyCollectionFunAdapter;
...
public class MyCollectionFunnyFragment extends BaseFragment implements MyCollectionView, SuperRecyclerView.LoadingListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    private MyCollectionFunAdapter mMyCollectionFunAdapter;
    ...
    protected void initData() {
        ...
        mMyCollectionFunAdapter = new MyCollectionFunAdapter(context, mList);
        ...
        initRecyclerView(rvContainer, mMyCollectionFunAdapter, this);
    ...
    public String getType() {
        return Constants.MYCOLLECTION_FUNNY;
    }
    ...
    public void getFunnySuccess(List<MyCollectionListInfo> list, int maxpage) {
        if (list.size() == 0) {
            ...
            mList.addAll(list);
            mMyCollectionFunAdapter.notifyDataSetChanged();
        }
    }
