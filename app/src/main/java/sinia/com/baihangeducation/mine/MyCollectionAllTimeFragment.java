...
import sinia.com.baihangeducation.mine.adapter.MyCollectionAllTimeAdapter;
...
public class MyCollectionAllTimeFragment extends BaseFragment implements MyCollectionView, SuperRecyclerView.LoadingListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    private MyCollectionAllTimeAdapter myCollectionAllTimeAdapter;
    ...
    protected void initData() {
        ...
        myCollectionAllTimeAdapter = new MyCollectionAllTimeAdapter(context, mList);
        ...
        initRecyclerView(rvContainer, myCollectionAllTimeAdapter, this);
    ...
    public String getType() {
        return Constants.MYCOLLECTION_ALLTIME;
    }
    ...
    public void getAllTimeSuccess(List<MyCollectionListInfo> list, int maxpage) {
        if (list.size() == 0) {
            ...
            mList.addAll(list);
            myCollectionAllTimeAdapter.notifyDataSetChanged();
        }
    }
