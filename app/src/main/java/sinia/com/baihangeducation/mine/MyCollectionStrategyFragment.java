...
public class MyCollectionStrategyFragment extends BaseFragment implements MyCollectionView, SuperRecyclerView.LoadingListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public String getType() {
        return Constants.MYCOLLECTION_STRATEGY;
    }
