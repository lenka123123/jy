...
public class MyCollectionSecretFragment extends BaseFragment implements MyCollectionView, SuperRecyclerView.LoadingListener, SwipeRefreshLayout.OnRefreshListener{
    ...
    public String getType() {
        return Constants.MYCOLLECTION_SECRET;
    }
