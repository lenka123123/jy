...
public class MyCollectionFunAndInfoAdapter extends SuperBaseAdapter<MyCollectionListInfo> {
    private Context context;
    private MyCollectionPresenter presenter;
    private List<MyCollectionListInfo> data;

    public MyCollectionFunAndInfoAdapter(Context context, List<MyCollectionListInfo> data) {
        super(context, data);
