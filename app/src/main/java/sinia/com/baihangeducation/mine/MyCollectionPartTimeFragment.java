...
public class MyCollectionPartTimeFragment extends BaseFragment implements MyCollectionView, SuperRecyclerView.LoadingListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    private MyCollectionPartTimeAdapter myCollectionPartTimeAdapter;
    ...
    protected void initData() {
        ...
        myCollectionPartTimeAdapter = new MyCollectionPartTimeAdapter(context, mList);
        ...
        initRecyclerView(rvContainer, myCollectionPartTimeAdapter, this);
    ...
    public String getType() {
        return Constants.MYCOLLECTION_PARTTIME;
    }
    ...
    public void getPatrTimeSuccess(List<MyCollectionListInfo> list, int maxpage) {
        if (list.size() == 0) {
            ...
            mList.addAll(list);
            myCollectionPartTimeAdapter.notifyDataSetChanged();
        }
    }
