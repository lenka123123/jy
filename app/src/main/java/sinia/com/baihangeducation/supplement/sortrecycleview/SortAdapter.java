package sinia.com.baihangeducation.supplement.sortrecycleview;
...
public class SortAdapter extends RecyclerView.Adapter<SortAdapter.ViewHolder> {
    ...
    private Context mAcitvity;

    public SortAdapter(Context mAcitvity, List<SortModel> data) {
        mInflater = LayoutInflater.from(mAcitvity);
        mData = data;
    ...
    public SortAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.sort_item, parent, false);
