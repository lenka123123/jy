...
public class CompanyUCenterReleasePartTimeActivity extends BaseActivity implements INotifyRefreshActivityView, ICompanyUCenterReleaseJobView, SuperRecyclerView.LoadingListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void initData() {
        mList = new ArrayList<>();
        mCommonTitle.setCenterText(R.string.companyUCenterparttime);
    ...
    public String getCompanyUCenterReleaseJobTypy() {
        return Constants.COMPANY_RELEASEJOB_PARTTIME + "";
    }
