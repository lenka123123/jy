...
public class CalendarAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.calen_calendar_item, null);
        }
...
//			}
            if (Integer.valueOf(currentMonth) == Integer.valueOf(sys_month) && Integer.valueOf(d) <= Integer.valueOf(currentDay)) {
                if (ds.equals("1")) {
                    textView.setBackgroundResource(R.drawable.new_issign);
...
//                    imgSelect.setVisibility(View.VISIBLE);
                    textView.setBackgroundResource(R.drawable.new_issign);
                    textView.setTextColor(Color.WHITE);
//                    convertView.setBackgroundResource(R.color.red_fa3e3e);
//					tvStatus.setVisibility(View.INVISIBLE);
                } else {
//                    imgSelect.setVisibility(View.INVISIBLE);
//					tvStatus.setVisibility(View.VISIBLE);
