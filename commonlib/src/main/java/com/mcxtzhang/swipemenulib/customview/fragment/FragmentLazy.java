package com.mcxtzhang.swipemenulib.customview.fragment;
 ...
 *
 */
public abstract class FragmentLazy extends BaseLifeCycleFragment {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle savedInstanceState) {
        ...
        isFirstLoad = true;
        view = initViews(layoutInflater, viewGroup, savedInstanceState);
        isPrepared = true;
        lazyLoad();
        return view;
    }
